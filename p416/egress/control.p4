...
hash_s9;
    ...
    apply {
		...
		if(hdr.instr[8].isValid()) { meta.instr_count = meta.instr_count + 4; instruction_8.apply(); hdr.instr[8].flags = 1; }
		if(hdr.instr[9].isValid()) { meta.instr_count = meta.instr_count + 4; instruction_9.apply(); hdr.instr[9].flags = 1; }
